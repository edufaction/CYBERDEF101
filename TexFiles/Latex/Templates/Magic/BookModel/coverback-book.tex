...
% ------CV --------------------------------------------------------------------------------------
\draw (current page.north west) node [fill=edxcolorcover!00!white,fill opacity=0,text opacity=1,inner sep=0cm,xshift= 6 cm,  yshift=-17 cm, anchor=north west]
...
\draw (current page.north west) node [fill=edxcolorcover!00!white,fill opacity=1,text opacity=1,inner sep=1cm,xshift= 2 cm,  yshift=-2 cm, anchor=north west]
...
% ------PHOTO--------------------------------------------------------------------------------------
\node at (current page.north west)   [xshift= 2cm,  yshift=-17cm, anchor=north west]  {\includegraphics[width=3cm]{\upath/Sources/EDU/SRC1/Pictures/Bitmaps/authorphoto.jpg}}; 
