...
%-------------------------------------------------------
\usepackage{\utemplatepath/LessonModel/Beamer/edxbeamer}
%-------------------------------------------------------
...
\begin{frame}[plain]
  ...
  \begin{column}{0.4\textwidth}
    ...
    \begin{figure}
        \begin{centering}
  			\includegraphics[width=\textwidth]{\utemplatepath/commons.inc/CommonsPictures/\utemplatetheme.theme/img-sec101.pdf}
  \end{centering}
  \end{figure}
      \end{column}
  ...
  \begin{column}{0.6\textwidth}
    \begin{figure}
        \begin{centering}
 		    \includegraphics[width=\textwidth]{\utemplatepath/commons.inc/CommonsPictures/\utemplatetheme.theme/cnambretagne.pdf}
    \end{centering}
  \end{figure}
  \end{column}
\end{columns}
...
\begin{frame}
 \frametitle{des questions ?}
  \framesubtitle{contacter \umaila}
  					\begin{figure}
  					 \centering
   						 \includegraphics[width=0.2\textwidth]{\utemplatepath/commons.inc/CommonsPictures/\utemplatetheme.theme/cyberdef101.pdf}\\
				  \end{figure}
