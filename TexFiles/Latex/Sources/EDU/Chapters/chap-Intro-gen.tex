...
\mode<all>{\picframe{Latex/Sources/EDU/Pictures/img-4model}{Cybersécurité, un domaine hollistique}{0.9}{lbli4model}}
...
\mode<all>{\picframe{Latex/Sources/EDU/Pictures/img-cycle}{Processus Cyber d'entreprise}{0.8}{lblcycle}}
...
\mode<all>{\picframe{Latex/Sources/EDU/Pictures/img-risk-assess}{le cyber-risque}{0.9}{lblriskassess}}
...
\mode<all>{\picframe{Latex/Sources/EDU/Pictures/img-risk-prison}{La menace, une vision de l'attaquant}{0.9}{lblriskjail}}
