...
\documentclass[10pt,fleqn,twoside]{\utemplatepath/LessonModel/Article/edxstyle} 
%edxstyle
...
%\begin{tikzpicture}[remember picture,overlay]\node at (current page.north west)[xshift=4cm, yshift=-4cm, text opacity=1.0]{\includegraphics[width=0.1\paperwidth]{\utemplatepath/commons.inc/CommonsPictures/\utemplatetheme.theme/shield-20.pdf}}; 
%\end{tikzpicture} 
%
%
%\AddToShipoutPicture{%
