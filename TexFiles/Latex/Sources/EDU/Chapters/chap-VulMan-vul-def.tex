...
\upicture{Latex/Sources/EDU/Pictures/img-hot}{les types de vulnérabilités}{0.7}{lblvulhot}
\end{frame}
% end PRZ ===========================
...
% end header PRZ =======================
\upicture{Latex/Sources/EDU/Pictures/img-vul-types}{Les types de vulnérabilités}{1}{lblvultypes}
\end{frame}
% end PRZ ===========================
...
\upicture{Latex/Sources/EDU/Pictures/img-smbfaille}{Tempo faille SMB - google}{0.6}{lblfaillesmb}
...
% end header PRZ =======================
\upicture{Latex/Sources/EDU/Pictures/img-zerodium}{Le marché des failles Serveurs avec Zerodium}{0.8}{lblzerodium}
\end{frame}
% end PRZ ===========================
