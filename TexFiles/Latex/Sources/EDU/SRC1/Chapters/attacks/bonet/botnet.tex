...
Le téléchargement de \gls{gROOTKIT} d'installation ou de \uac{aDLL} complémentaire finalise la mise en place du botnet sur la machine infectée.	
...
\upicture{../Latex/Sources/EDU/SRC1/Pictures/img-reseau_aleatoire}{Architecture aléatoire}{0.75}{lbl:netall}
