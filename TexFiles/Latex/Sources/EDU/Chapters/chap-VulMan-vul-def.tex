...
% end header PRZ =======================
\upicture{Latex/Sources/EDU/Pictures/img-hot}{les types de vulnérabilités}{0.6}{lblvulhot}
\end{frame}
% end PRZ ===========================
...
% end header PRZ =======================
\upicture{Latex/Sources/EDU/Pictures/img-zerodium}{Le marché des failles mobiles avec Zerodium}{0.6}{lblzerodium}
\end{frame}
% end PRZ ===========================
