...
\g{\texttt{un titre de mon image/"><script>...script malveillant...;</script>!}}
\\
%---------------------------------------------------
\begin{lstlisting} [language=html]
<html>...
...
La chaîne  \g{\texttt{OU 'x'='x'!}} étant toujours VRAI, on pourrait obtenir des informations complètes de certaines tables.
