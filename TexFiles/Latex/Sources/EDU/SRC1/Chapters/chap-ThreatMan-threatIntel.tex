...
\mode<all>{\picframe{../Latex/Sources/EDU/SRC1/Pictures/img-veillecyber}{Veille cyber, une veille sur les risques}{0.7}{lblveillecyber}}
...
\mode<all>{\picframe{../Latex/Sources/EDU/SRC1/Pictures/img-threatvigil}{Les sources}{0.8}{lblthreatvigil}}
