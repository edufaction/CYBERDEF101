...
\mode<all>{\picframe{../Latex/Sources/EDU/Pictures/img-metiers}{les  grands domaines de métiers}{0.8}{lblmetiers}}
...
\mode<all>{
\picframe{../Latex/Sources/EDU/Pictures/img-metiers-risk2crisis}
...
\mode<all>{\picframe{../Latex/Sources/EDU/Pictures/img-metierslist}{les métiers dans le cycle de vie}{0.8}{lblmetiersall}}
