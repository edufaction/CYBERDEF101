...
{
\input{Latex/Sources/EDU/Chapters/#1}
}
...
sharp corners, 
  ...
  coltitle = uMainColor!20!black,
  fonttitle = \bfseries, 
  title    =  {\textcolor{uMainColor}{\faFile~\small {Sujet de mémoire SECOPS}}} : #2,
  #1,
}
...
\newcommand{\toolsbox}[2]
{
\input{Latex/Sources/EDU/SecComponents/#2.#1/datas.tex} 
\begin{toolsboxin}[sidebyside,righthand width=.7\textwidth]{#1}
\includegraphics[width=0.9\textwidth]{Latex/Sources/EDU/SecComponents/#2.#1/icon.png} \\
\tcblower
\input{Latex/Sources/EDU/SecComponents/#2.#1/description.tex}
\end{toolsboxin}
...
%---------------------------------------------------
\newcommand {\uexpand}[1]{
\mode<all>\input{Latex/Sources/EDU/Chapters/#1}
}
...
%\begin{figure}[!h] %h
  \begin{center}
	 \includegraphics[height=0.8\textheight, width=0.8\textwidth, keepaspectratio ]{#1.pdf}
  \end{center}
%  \end{figure}
}
\else
...
\frametitle<presentation>{#2}
  \begin{center}
	 %\includegraphics[height=#3\textheight, width=#3\textwidth,keepaspectratio ]{#1.pdf}
   %\includegraphics[height=#3\textheight, keepaspectratio ]{#1.pdf}

   \begin{tikzpicture}[remember picture, overlay]
    \node at (current page.center) {\includegraphics[width=#3\paperwidth, height=#3\paperheight,keepaspectratio]{#1.pdf}};
    \end{tikzpicture}
...
%-----------------------------------------------------
  ...
  \newcommand{\utodo}{\begin{center}{\noindent \textcolor{cyan}{\faGears~{chapitre en cours de rédaction, DRAFT non publiable} \faGears}}\end{center}}
  
    \newcommand{\utocomplete}{\begin{center}{\noindent \textcolor{blue}{\faClipboard~{chapitre à compléter, les éléments ne donnent qu'une vue trop réduite ou parcellaire du sujet}}}\end{center}}
  

  %{\noindent \textcolor{cyan} {\faRefreshs~Chapitre en cours de rédaction, à compléter}}
