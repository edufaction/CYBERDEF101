...
\ifcsname utemplatetheme\endcsname
  \def\utemplatethemeprepose{YES}
\else
  \def\utemplatetheme{orange}
\fi

\ifcsname upicturethemepath\endcsname
  \def\upicturethemepathprepose{YES}
\else
  \def\upicturethemepath{}
\fi

%\ifundefined{utemplatetheme}{\def\utemplatetheme{orange}}{NO}

% \def\utemplatetheme{orange-inverted}
...
\newcommand*{\localcourseinstitute}{CyberSkills4All}
...
\newcommand{\uJournalInfo}{\localcourseinstitute, par Orange Security School}

\newcommand{\udescription}{}



\newcommand{\uUniversity}{AMI-CMA-CyberSkills4All}

\newcommand{\uinstituteshort}{\localcourseinstitute}
\newcommand{\uinstitute}{\localcourseinstitute}
\newcommand{\uchaire}{Direction technique \& scientifique OSS}
