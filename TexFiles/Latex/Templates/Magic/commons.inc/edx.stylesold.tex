...
%%\definecolor{uMainColor}{RGB}{243,102,25} % Define the orange color used for highlighting throughout the book
...
{\color{uMainColor!60}\contentslabel[\Large\thecontentslabel]{1.25cm}\color{uMainColor}} % Chapter number
{\color{uMainColor}}  
...
\node[draw=uMainColor!60,line width=1pt,circle,fill=uMainColor!25,font=\sffamily\bfseries,inner sep=2pt,outer sep=0pt] at (-15pt,0pt){\textcolor{uMainColor}{R}};\end{tikzpicture}} % Orange R in a circle
...
\makeatletter
\renewcommand{\@seccntformat}[1]{\llap{\textcolor{uMainColor}{\csname the#1\endcsname}\hspace{1em}}}                    
...
\node[anchor=north] at (4cm,-3.25cm){\color{uMainColor!40}\fontsize{220}{100}\sffamily\bfseries\@Roman\c@part}; 
...
\draw[anchor=west] (\Gm@lmargin,-9cm) node [line width=2pt,rounded corners=15pt,draw=uMainColor,fill=white,fill opacity=0.5,inner sep=15pt]{\strut\makebox[22cm]{}};
...
\usepackage{hyperref}
\hypersetup{hidelinks,colorlinks=false,breaklinks=true,urlcolor= uMainColor,bookmarksopen=false,pdftitle={Title},pdfauthor={Author}}
\usepackage{bookmark}
\bookmarksetup{
open,
numbered,
