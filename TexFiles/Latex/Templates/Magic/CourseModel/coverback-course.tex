...
% ------PHOTO--------------------------------------------------------------------------------------
\node at (current page.north west)   [xshift= 2cm,  yshift=-17cm, anchor=north west]  {\includegraphics[width=3cm]{\utemplatepath/CourseModel/CoursePictures/\utemplatetheme.theme/edu.png}}; 
