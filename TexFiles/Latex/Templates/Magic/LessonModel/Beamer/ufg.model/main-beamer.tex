\documentclass[ignorenonframetext,allowframebreaks,aspectratio=169,t,9pt, xcolor=table,center]{beamer}
...
\ifdefined\noteslide
\setbeamertemplate{note page}{\pagecolor{uCoverColor!5}\insertnote}
\usepackage{pgfpages}
...
%edx.command.tex AudioNote export
...
\mode<all>{\immediate\closeout\audioexport} % edx.command.tex AudiNote export
\end{document}
