...
\colorlet{edxcolorcover}{uCoverColor}                 
...
\node at (current page.north west)
			...
			%\draw[anchor=north west] node [fill=uMainColor!20]{\strut\makebox[\paperwidth]{}};

			\fill[uMainColor!20](0cm,0cm) rectangle (\paperwidth,-0.4\paperheight);

			%\fill[uMainColor!20] (current page.north west) rectangle (\paperwidth,0.3\paperheight);

			\draw[anchor=west] (\Gm@lmargin,-9cm) node [line width=4pt,rounded corners=15pt,draw=uMainColor!60,fill=white,fill opacity=1,inner sep=15pt]{\strut\makebox[\paperwidth]{}};
			...
			%\node at (current page.north east)  [xshift=-3.95cm, yshift=-4.05cm, text opacity=1]  {{\color{white}\centering\fontsize{150}{30}\selectfont \bfseries\sffamily\thechapter\strut} };
			\node at (current page.north east)  [xshift=-4cm, yshift=-4cm, text opacity=1]  {{\color{uMainColor!60}\centering\fontsize{150}{30}\selectfont \bfseries\sffamily\thechapter\strut} };
