...
\mode<all>{\picframe{../Latex/Sources/EDU/Pictures/img-4model}{Cybersécurité, un domaine hollistique}{0.7}{lbli4model}}

%\includegraphics{../Latex/Sources/EDU/Pictures/img-4model}
...
\mode<all>{\picframe{../Latex/Sources/EDU/Pictures/img-cycle}{Processus Cyber d'entreprise}{0.7}{lblcycle}}
...
\mode<all>{\picframe{../Latex/Sources/EDU/Pictures/img-risk-assess}{le cyber-risque}{0.8}{lblriskassess}}
...
\mode<all>{\picframe{../Latex/Sources/EDU/Pictures/img-risk-prison}{La menace, une vision de l'attaquant}{0.8}{lblriskjail}}
...
\mode<all>{\picframe{../Latex/Sources/EDU/Pictures/img-cyclevie}{Cycle de vie sécurité dans les projets}{0.8}{lblcycledevie}}
